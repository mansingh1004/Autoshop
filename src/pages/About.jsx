...
//   return (
//     <section className="bg-[#0f172a] text-slate-300 py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      
//       {/* Dynamic Background Glows */}
//       <div className="absolute top-0 left-[-10%] w-[50%] h-[50%] bg-blue-600/10 blur-[150px] rounded-full z-0 pointer-events-none"></div>
...
//             <h1 className="bg-gradient-to-r from-red-600 to-orange-500 text-white px-10 py-3 rounded-xl text-3xl md:text-5xl font-black uppercase italic tracking-tighter shadow-[0_10px_30px_-10px_rgba(220,38,38,0.5)] transform -skew-x-12">
//               Who We Are
//             </h1>
//           </div>
//           <p className="mt-8 text-slate-400 font-bold uppercase tracking-[0.2em] text-sm max-w-2xl">
...
//               More than just a workshop, we are your <span className="text-red-500 italic">trusted auto partners.</span>
//             </h2>
//             <p className="text-slate-400 leading-relaxed text-lg">
//               Founded in 2008, AutoShop World started with a simple mission: to provide dealership-quality car repairs without the dealership price tag. Over the years, we have grown from a small two-bay garage into a state-of-the-art automotive care center.
//             </p>
//             <p className="text-slate-400 leading-relaxed text-lg">
...
//               <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-xl font-black uppercase tracking-widest transition-all active:scale-95 shadow-lg shadow-red-900/30">
//                 Meet The Team
//               </button>
//             </div>
//           </div>
...
//             <div className="relative rounded-3xl overflow-hidden border border-slate-700 shadow-2xl aspect-video lg:aspect-square group">
//               <div className="absolute inset-0 bg-slate-800/80 group-hover:bg-transparent transition-colors duration-700 z-10"></div>
//               <img 
...
//               {/* Floating Badge */}
//               <div className="absolute bottom-6 left-6 z-20 bg-slate-900/90 backdrop-blur-md border border-slate-700 p-6 rounded-2xl shadow-xl flex items-center gap-4">
//                 <Target className="text-red-500 w-10 h-10" />
//                 <div>
//                   <p className="text-white font-bold text-xl">Our Mission</p>
...
//             <div key={index} className="bg-slate-800/40 backdrop-blur-sm border border-slate-700 p-8 rounded-2xl flex flex-col items-center text-center group hover:bg-slate-800 transition-colors">
...
//               Why Choose <span className="text-red-500">AutoShop?</span>
//             </h2>
...
//               <div key={index} className="flex gap-6 bg-slate-900 p-8 rounded-2xl border border-slate-800 hover:border-red-500/30 transition-colors">
