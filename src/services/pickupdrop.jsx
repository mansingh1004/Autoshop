...
const PickupDropDetail = () => {
  ...
  const handleBooking = async (e) => {
    ...
    formData.append("subject", "New Pickup Request: Free Pickup & Drop");
    ...
    try {
      ...
      if (res.success) {
        setFormStatus("Success! We will contact you for pickup.");
        setTimeout(() => {
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans relative">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <div className="relative bg-slate-900 w-full max-w-lg rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-white/10 animate-in zoom-in duration-300">
            ...
            <h2 className="text-2xl font-black text-white mb-2 uppercase italic">Schedule Pickup</h2>
            <p className="text-slate-400 text-sm mb-8 font-medium">Doorstep Convenience • ₹0 Service Fee</p>
            ...
            <form onSubmit={handleBooking} className="space-y-4">
              ...
              />
              <input 
                type="text" name="address" placeholder="Pickup Address" required
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-red-600 transition-all"
              />
              
              <button 
                disabled={isSubmitting}
                className="w-full bg-red-600 hover:bg-red-700 text-white font-black uppercase tracking-widest py-5 rounded-xl flex items-center justify-center gap-3 transition-all active:scale-95 disabled:opacity-50 shadow-xl shadow-red-900/40"
              >
      ...
      <div className="bg-slate-50 border-b border-slate-200 py-4">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-sm font-medium text-slate-500">
          ...
          <ChevronRight size={16} />
          <span className="text-slate-900">Free Pickup & Drop</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-slate-950 leading-tight">
              Service Your Car <br /> 
              <span className="text-red-600">Without Leaving Home</span>
            </h1>

            <p className="text-lg text-slate-600 leading-relaxed">
              Why waste time in traffic? Our Free Pickup & Drop service ensures your car gets the expert care it needs while you stay productive. We handle the logistics so you don't have to.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 border-y border-slate-100 py-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold">Safe Transit</p>
                  <p className="text-xs text-slate-500">Insured Movements</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center text-red-600">
                ...
                <div>
                  <p className="text-sm font-bold">Verified Drivers</p>
          ...
          <div className="lg:sticky lg:top-32">
            <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-10 text-white shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 text-sm mb-8">Available across the city for all service types.</p>
                
                <div className="space-y-6">
                  <div className="bg-white/5 border border-white/10 p-5 rounded-2xl flex justify-between items-center">
                    <div>
                      <p className="text-xs font-bold text-red-500 uppercase tracking-tighter">Service Charge</p>
                      <p className="text-3xl font-black">₹0</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs text-slate-500 line-through font-bold">₹500</p>
                      <p className="text-sm text-green-400 font-bold">Free with Service</p>
                    </div>
                  </div>
                  ...
                  <p className="text-center text-[10px] text-slate-500 uppercase font-bold tracking-[0.2em]">
                    Real-time Location Sharing Included
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-6 border border-slate-100 rounded-3xl flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold tracking-tight text-slate-900">Check Area Coverage?</p>
                  <p className="text-xs text-slate-500 font-medium">Talk to our logistics team</p>
                </div>
              </div>
...
export default PickupDropDetail;