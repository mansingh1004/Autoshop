...
const CarDetailingDetail = () => {
  ...
  const handleBooking = async (e) => {
    ...
    formData.append("subject", "New Booking: Professional Car Detailing");
    ...
    try {
      ...
      if (res.success) {
        setFormStatus("Success! We will contact you for a consultation.");
        setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans relative">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <div className="relative bg-slate-900 w-full max-w-lg rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-white/10 animate-in zoom-in duration-300">
            ...
            <h2 className="text-2xl font-black text-white mb-2 uppercase italic">Exclusive Consultation</h2>
            <p className="text-slate-400 text-sm mb-8 font-medium">Premium Detailing • Custom Pricing</p>
            ...
            <form onSubmit={handleBooking} className="space-y-4">
              ...
              />
              <input 
                type="text" name="car_model" placeholder="Car Model (Luxury / Sports / SUV)" required
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-red-600 transition-all"
              />
      ...
      <div className="relative h-[55vh] md:h-[65vh] w-full overflow-hidden">
        ...
        {/* Placeholder Hero Image - Recommend a high-gloss car photo */}
        <img 
          src="https://images.unsplash.com/photo-1607860108855-64acf2078ed9?auto=format&fit=crop&q=80&w=2000" 
          alt="Luxury car professional detailing and ceramic coating" 
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-end pb-12 px-6">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-4xl md:text-7xl font-black text-white leading-tight uppercase italic tracking-tighter drop-shadow-lg">
              The Ultimate <span className="text-red-600">Detailing</span> <br /> 
              Masterclass
            </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 bg-red-50 text-red-600 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">
              <Gem size={14} />
              Elite Protection & Shine
            </div>
            
            <h2 className="text-3xl md:text-5xl font-black text-slate-950 leading-tight">
              Beyond Clean: <br /> 
              <span className="text-red-600">Perfection in Every Detail</span>
            </h2>

            <p className="text-lg text-slate-600 leading-relaxed font-medium">
              Standard washing only goes skin-deep. Our detailing service is an intensive restoration process that removes swirls, protects the clear coat, and creates a <span className="text-slate-900 font-bold underline decoration-red-600">mirror-like reflection</span> that lasts for years.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 border-y border-slate-100 py-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-black uppercase tracking-tighter">Ceramic Pro</p>
                  <p className="text-xs text-slate-500 font-medium">Nano-Tech Defense</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center text-red-600 shadow-sm">
                ...
                <div>
                  <p className="text-sm font-black uppercase tracking-tighter">Paint Shield</p>
                  <p className="text-xs text-slate-500 font-medium">Scratch Resistance</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:sticky lg:top-10">
            <div className="bg-slate-950 rounded-[2.5rem] p-8 md:p-10 text-white shadow-2xl relative overflow-hidden border border-white/5">
              <Shield className="absolute -bottom-10 -right-10 text-white/5 w-64 h-64 -rotate-12" />
              
              <div className="relative z-10">
                <h2 className="text-2xl font-black uppercase italic mb-2 tracking-tighter">Preserve Your Asset</h2>
                <p className="text-slate-400 text-sm mb-8 font-medium">Professional grade coating and interior restoration.</p>
                
                <div className="space-y-6">
                  <div className="bg-white/5 border border-white/10 p-6 rounded-2xl flex flex-col gap-1 backdrop-blur-md">
                    <p className="text-[10px] font-black text-red-500 uppercase tracking-widest">Detailing Packages</p>
                    <p className="text-xl font-bold">Customized Quotes Only</p>
                    <p className="text-xs text-slate-400">Based on vehicle size and paint condition.</p>
                  </div>
            ...
            <div className="mt-8 p-8 border border-slate-100 rounded-[2rem] flex items-center justify-between bg-slate-50/50 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-black tracking-tight uppercase text-slate-950">Expert Advice?</p>
                  <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Talk to our lead detailer</p>
                </div>
              </div>
...
export default CarDetailingDetail;